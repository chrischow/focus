...
{:else if type === 'text'}
  <input
    ...
    {placeholder}
    class="block w-full bg-none border-none focus:outline-none focus:bg-slate-100 focus:ring-0 rounded-md -ms-2 px-2 py-2 !mt-0 placeholder-slate-400 text-slate-600 text-lg"
  />
{:else}
  <textarea
    ...
    on:change={() => handleChange(content)}
    {placeholder}
    class="block w-full bg-none border-none focus:outline-none focus:bg-slate-100 focus:ring-0 rounded-md -ms-2 px-2 py-2 !mt-0 placeholder-slate-400 text-slate-600"
  />
{/if}
